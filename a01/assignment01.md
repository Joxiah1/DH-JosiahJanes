...
| **3. User Control and Freedom:**<br>The website effectively guides users to avoid unwanted navigation or dialogue. | **Good:** The site makes great use of undo and redo features and users can easily backtrack to previous pages using the browser's navigation arrows.<br>**Bad:** x | Improvements Here | Severity Here |
